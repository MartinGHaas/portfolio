const About = () => {
  return (
    <div className="w-full h-full">
      <img src="not_rust.png" alt="" className="w-500px -rotate-6 aspect-auto fixed -bottom-2 -left-5" />
      <div className="h-full flex flex-col justify-around items-center">
        <h1 className="text-8xl font-bold">Martin Haas</h1>
      ...
      <img src="backpack.png" alt="" className="w-500px aspect-auto fixed bottom-0 -right-8"/>
    </div>
  )
}
